...
#' @export
#'
outcomeData <- getOutcomeData(connectionDetails = connectionDetails, 
...
getOutcomeData<-function(connectionDetails = connectionDetails, 
    ...
    population <- PatientLevelPrediction::createStudyPopulation(plpData = plpData,
                                                                ...
                                                                requireTimeAtRisk = TRUE)
    plpData$covariates
    return(list(targetCohortId = targetCohortId,
...
#' 
#' 
calculateSurvival <- function(populationData = populationData,
    ...
    colnames(outcomeData$population)<-gsub("aggregatedNum","targetNum",colnames(outcomeData$targetCohort))
